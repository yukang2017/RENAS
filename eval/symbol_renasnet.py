...
def Cell(config_code,
    ...
    if cell_type is 'Normal' and bang:
...
def get_symbol(model_type='renasnet-ImageNet',
    ...
    # Enasnet
    e_normal_code = [[0,1],[7,1],[1,1],[7,0],[3,0],[0,1],[0,0],[3,1],[1,1],[3,0]]
    e_reduct_code = [[1,0],[3,1], [0,1],[3,1], [3,1],[0,1], [1,4],[3,1], [0,5],[1,0]]

    # Pnasnet
    p_code = [[2, 1], [4, 1], [1, 1], [0, 1], [7, 1], [0, 0], [1, 0], [4, 0], [4, 1], [0, 3]]

    renasnet = [[1, 0], [0, 1], [7, 1], [0, 1], [0, 0], [3, 0], [1, 1], [0, 0], [7, 2], [0, 2]] # 5.366M 580M  B

    normal_code = renasnet
    reduct_code = renasnet
